...
# pylint: disable=C0301, C0304, E0602, W1309, W0621, C0116
...
def add_image(user_id, tags, user_collection, image_collection):
    """
    Creates a new instance of Picture and stores it in image_collection
    """
    return list_user_images.add_image(user_id, tags, user_collection, image_collection)


def list_of_user_images(user_id):
    """
    Lists user images stored on directory
    """
    return list_user_images.list_of_user_images(user_id)


def reconcile_images(user_id, user_collection, image_collection):
    """
    Creates a new instance of Picture and stores it in user_collection
    """
    return list_user_images.reconcile_images(user_id, user_collection, image_collection)