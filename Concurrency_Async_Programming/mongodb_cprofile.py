...
def profile(function, *args):
    ...
    # create stats report in text file format
    file = open("mongodb_multiprocessing_size_100000.txt", "a")
...
if __name__ == '__main__':
    ...
    with mongo:
        ...
        profile(main.load_users, "accounts.csv")
        profile(main.load_status_updates, "status_updates.csv")
