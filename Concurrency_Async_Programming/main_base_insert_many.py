...
def load_users(filename, user_collection):
    ...
    try:
        user_collection.database.UserAccounts.insert_many(list_of_users, ordered = False)
...
def load_status_updates(filename, status_collection):
    ...
    try:
        status_collection.database.StatusUpdates.insert_many(list_of_status,ordered = False)
    except pymongo.errors.BulkWriteError as e:
        logger.warning(e.details)
    return True
